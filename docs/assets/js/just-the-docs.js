(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://dnnsmnstrr.github.io/zettelkasten/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://dnnsmnstrr.github.io/zettelkasten/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://dnnsmnstrr.github.io/zettelkasten/assets/css/just-the-docs-' + theme + ".css"
      );
    };
